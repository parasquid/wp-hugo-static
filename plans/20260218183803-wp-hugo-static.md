...
> - WP→Hugo conversion scripts (posts + pages)
...
| CI/CD | GitHub Actions | Build → Cloudflare Pages |
...
- `scripts/fetch-wp-content.py` for WP→Hugo conversion
...
2. Publish test post → verify Actions trigger
...
↓ Task 1.2: WUD configuration
↓ Task 1.3: Backup system with cron
↓ Task 1.4: Tailscale integration
↓ Task 1.5: WordPress initial config + security

Phase 2 (Week 2-3): Hugo Base Setup
↓ Task 2.1: Hugo initialization with Stack theme
↓ Task 2.2: Hugo configuration (hugo.toml)
↓ Task 2.3: Giscus integration
↓ Task 2.4: Basic content structure + sample posts

Phase 3 (Week 3-4): Content Pipeline
↓ Task 3.1: WP→Hugo conversion scripts (posts)
↓ Task 3.2: WP→Hugo conversion scripts (pages)
↓ Task 3.3: Image download and optimization
↓ Task 3.4: GitHub Actions workflow
↓ Task 3.5: WP webhook integration
↓ Task 3.6: Hybrid content support (custom pages)

Phase 4 (Week 4-5): Polish & Documentation
↓ Task 4.1: Generic setup.sh script
↓ Task 4.2: Comprehensive README
↓ Task 4.3: Theme customization (site-specific)
↓ Task 4.4: Security hardening and review

Phase 5 (Week 5-6): Launch & Open Source
↓ Task 5.1: Final end-to-end testing
↓ Task 5.2: Content migration
↓ Task 5.3: Domain and DNS setup
↓ Task 5.4: Open source preparation
↓ Task 5.5: Repository publication
```
...
- [ ] 3.1 Create WP→Hugo conversion script for posts
...
- [ ] 3.2 Create WP→Hugo conversion script for pages
...
- [ ] 5.1 Final end-to-end testing
  ...
  **What to do**:
  - Test complete workflow: WP publish → GitHub Actions → Cloudflare Pages
...
- [ ] 5.3 Domain and DNS setup
  ...
  **What to do**:
  ...
  - Configure www redirect (www → apex or vice versa)
...
- [ ] 5.4 Open source preparation
  ...
  **Must NOT do**:
  ...
  - Do not use restrictive license (keep it permissive)
...
- [ ] F2. **End-to-end Test** — WP publish → live site within 5 minutes
- [ ] F3. **Backup/Restore Test** — restore from backup works
- [ ] F4. **Documentation Review** — README is clear and complete
...
| Phase 3 | `feat(pipeline): WP→Hugo conversion and CI/CD` | scripts/, .github/workflows/ |
